...
echo "============================================================"
echo " Atualizador de Bootloader - nice!nano (DVS Wireless) - Linux"
echo "============================================================"
echo ""
...
if ! command -v adafruit-nrfutil &> /dev/null; then
    ...
    if ! command -v adafruit-nrfutil &> /dev/null; then
        echo "Tente: pip3 install --user adafruit-nrfutil"
        echo "E adicione ~/.local/bin ao PATH:"
...
read -p "Digite o caminho completo da porta (ex: /dev/ttyACM0): " PORTA
